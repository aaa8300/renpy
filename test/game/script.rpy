...
# music
init python:
    renpy.music.register_channel("looping_sound", mixer="sound", loop=True)
    renpy.music.register_channel("looping_sound_two", mixer="sound", loop=True)
    renpy.music.register_channel("finale_sound", mixer="sound", loop=False)
...
label start:
    play looping_sound "music idea 1.wav"
    # PREMISE
    scene newsroom
...
label kingdom:
    play looping_sound_two "music idea 2.wav"
...
# PART 5: FINALE
label finale:
    play finale_sound "chase idea 2.mp3"
